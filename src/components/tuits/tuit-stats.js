...
const TuitStats = ({tuit, likeTuit, dislikeTuit, forceUnlike, forceUnDislike = () => {}}) => {
    return (
      <div className="row mt-2">
        ...
        <div className="col">
          <span onClick={() => {likeTuit(tuit); forceUnDislike(tuit)}}>
              {
        ...
        <div className="col">
          <span onClick={() => {dislikeTuit(tuit); forceUnlike(tuit)}}>
              {
